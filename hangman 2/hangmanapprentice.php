...
session_start();
print "<h1 style = 'text-align: center; color: limegreen; text-shadow: 3px 3px black'>You are in Apprentice Mode.</h1>";
print "<h2 style = 'text-align : center; color: limegreen; text-shadow: 3px 3px black'> Hint: States </h2>";
...
$words = [
    "GEORGIA", "WASHINGTON", "FLORIDA", "CALIFORNIA"
];
    ...
    <div style="display:inline-block; width: 500px; background:#fff;">
       ...
       <!-- status -->
        ...
        <?php if($WON  && gameComplete()):?>
            ...
            <p style="color: limegreen; font-size: 50px;">You Won! + 15 points
        <?php if($WON){
            $points=$points+15;
            echo $points;

...
session_start();
print "<h1 style = 'text-align: center; color: springgreen; text-shadow: 3px 3px black'>You are in Novice Mode.</h1>";
print "<h2 style = 'text-align : center; color: springgreen; text-shadow: 3px 3px black'> Hint: Fruits </h2>";
...
<div style="margin: 0 auto; background: gainsboro; width:900px; height:900px; padding:5px; border-radius:3px;">
    ...
    <div style="display:inline-block; width: 500px; background:#fff;">
        ...
        <?php if($WON  && gameComplete()):?>
            ...
            <p style="color: limegreen; font-size: 50px;">You Won! + 10 points
            <?php if($WON){
                $points=$points+10;
            echo $points;
        }
